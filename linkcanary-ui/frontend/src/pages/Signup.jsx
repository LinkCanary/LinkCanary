...
import { signUpEmail, signInSocial } from '../services/auth';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1a1f2e] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#2B3A4A] dark:text-white">Create your account</h1>
          <p className="mt-2 text-gray-500 dark:text-gray-400">Start finding broken links for free</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#232a3b] rounded-2xl shadow-lg p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-3 bg-white dark:bg-[#232a3b] text-gray-400">or sign up with email</span></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[#2B3A4A] dark:text-gray-300 mb-1">Password</label>
              <input
                type="password"
                value={password}
